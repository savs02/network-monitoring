"""
TVD experiment — discrete distributions, realistic mode (multi-seed).
...
Reads the CSVs generated by run_sample_complexity_discrete_realistic_seeded.sh.
For each distribution and sample size, computes TVD across all 100 seeds and
produces a box plot of TVD vs n with the theoretical bound overlaid.
...
RESULTS_DIR = os.path.join(SCRIPT_DIR, "../../results/sample-complexity/discrete/realistic/seeded")
...
def print_parameters():
    print("=" * 60)
    print("Discrete TVD experiment — realistic mode (multi-seed)")
    print("=" * 60)
...
def plot_distribution(emp_pmf, true_pmf_vals, support, dist_config, n, tvd_val, seed):
    ...
    ax.bar(support - bar_width / 2, emp_pmf, width=bar_width,
           ...
           label=f"Empirical PMF (n={n:,}, seed={seed}, realistic)")
